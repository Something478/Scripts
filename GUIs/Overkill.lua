...
mainFrameStroke.Color = Color3.fromRGB(100, 0, 200)
...
ToolKill["Creator_4"]["TextColor3"] = Color3.fromRGB(140, 0, 255);
...
ToolKill["Kill_6"]["TextColor3"] = Color3.fromRGB(220, 180, 255);
ToolKill["Kill_6"]["BackgroundColor3"] = Color3.fromRGB(60, 0, 140);
...
ToolKill["ScriptName_8"]["TextColor3"] = Color3.fromRGB(140, 0, 255);
...
ToolKill["List_a"]["BackgroundColor3"] = Color3.fromRGB(60, 0, 140);
ToolKill["List_a"]["TextColor3"] = Color3.fromRGB(220, 180, 255);
...
ToolKill["Loop_d"]["TextColor3"] = Color3.fromRGB(220, 180, 255);
ToolKill["Loop_d"]["BackgroundColor3"] = Color3.fromRGB(60, 0, 140);
...
ToolKill["TextBox_f"]["PlaceholderColor3"] = Color3.fromRGB(100, 100, 100);
...
ToolKill["Close_12"]["TextColor3"] = Color3.fromRGB(220, 180, 255);
ToolKill["Close_12"]["BackgroundColor3"] = Color3.fromRGB(60, 0, 140);
...
playerListStroke.Color = Color3.fromRGB(100, 0, 200)
...
ToolKill["PlayerListTitle"]["TextColor3"] = Color3.fromRGB(140, 0, 255);
...
local function updatePlayerList()
    ...
    for _, player in pairs(Players:GetPlayers()) do
        ...
        playerButton.BackgroundColor3 = Color3.fromRGB(60, 0, 140)
        playerButton.BorderSizePixel = 0
        playerButton.TextColor3 = Color3.fromRGB(220, 180, 255)
        ...
        if LocalPlayer.Character and Player.Character and Player.Character.PrimaryPart then
            ...
            if Tool ~= nil then
                ...
                while tick() - startTime < 5 do
                    if not Tool or not Tool.Parent or Tool.Parent == workspace or Tool.Parent == Player.Character then
                        killSuccess = true
                        break
                    end
                    if Player.Character and Player.Character.Humanoid and Player.Character.Humanoid.Health <= 15 then
                        killSuccess = true
                        break
                    end
                    task.wait(0.1)
...
ToolKill["Loop_d"].MouseButton1Click:Connect(function()
    ...
    if loopKillEnabled then
        ...
        if targetPlayer then
            ...
            ToolKill["Loop_d"].BackgroundColor3 = Color3.fromRGB(80, 0, 180)
